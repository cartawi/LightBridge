...
# LightBridge 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/Wei-Shaw/LightBridge/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="Wei-Shaw/LightBridge"
...
Documentation=https://github.com/Wei-Shaw/LightBridge
